...
public class HookLoader2 implements IXposedHookLoadPackage {
     ...
     */
    private final String modulePackage = "com.lamandys.xposedtest";
    /**
    ...
    static {
        hostAppPackages.add("com.yuanwofei.cardemulator.pro");
        hostAppPackages.add("com.lamandys.xposedtest");
    }
